...
# Get input and store as ints
weight_limak, weight_bob = list(map(int, input().split()))

# Var to hold years passed
years_passed = 0

# While weight of Limak is less than or equal to Bob's: update their weights and increase year counter by 1.
